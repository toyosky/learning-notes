...
|------|---------|---------|-----------|-------|---------|
| **DCA（无择时）** | **+22.34%** | -0.52% | 66/66 | 66,000 | 80,744 |
| DCA + MA10 | +20.70% | -0.52% | 34/66 | 34,000 | 41,036 |
| DCA + MA20 | +19.26% | -0.52% | 27/66 | 27,000 | 32,199 |
| DCA + MA60 | +18.37% | -0.52% | 30/66 | 30,000 | 35,510 |
...
- **DCA（无择时）** 累计收益最高（+22.34%），但本金投入也最多（66,000）
- **DCA + MA 择时** 买入次数大幅减少（34~27 次 vs 66 次），本金投入少一半以上
- 均线择时在这个区间内**并未提升收益率**，因为 2021 年初回调后大部分时间呈震荡上行，频繁空仓错过了部分涨幅
- **各策略均跑赢一次性买入**（-0.52%），体现了定投分散风险的优势
